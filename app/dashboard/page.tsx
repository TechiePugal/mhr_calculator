    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="md:ml-64 pt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {firebaseError && (
            <Alert className="mb-6 bg-yellow-50 border-yellow-200">
              ...
              <AlertDescription className="text-yellow-800">
                <strong>Notice:</strong> Firebase connection unavailable. The app is running in offline mode with sample
                data. Your calculations will be saved locally.
              </AlertDescription>
            </Alert>
          )}
          ...
          {/* Welcome Section */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to Machine Hour Rate Calculator</h1>
            <p className="text-gray-600">Manage your machine calculations and analyze cost efficiency</p>
          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Your latest machine calculations</CardDescription>
                </div>
                <Link href="/machines">
